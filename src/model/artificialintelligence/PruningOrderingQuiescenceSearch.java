...
public class PruningOrderingQuiescenceSearch extends Observable implements MoveStrategy {
    ...
    public PruningOrderingQuiescenceSearch(final int searchDepth) {
    ...
    public String toString() {
        return "Alpha Beta Pruning + Move Ordering + Quiescence Search";
    }
